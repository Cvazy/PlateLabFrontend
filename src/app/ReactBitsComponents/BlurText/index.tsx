...
export const BlurText: React.FC<BlurTextProps> = ({
  ...
  return (
    <p
      ref={ref}
      className={`no-transition blur-text ${className} flex flex-wrap`}
    >
      {springs.map((props, index) => (
        <AnimatedSpan
          key={index}
          style={props}
          className="no-transition inline-block transition-transform will-change-[transform,filter,opacity]"
        >
