import styles from "@/app/home/components/Difference/components/MainContainer/components/ComparisonBlock/ComparisonBlock.module.css";
    ...
    <div className={"relative bg-[#0A0A0A] w-fit min-w-52"}>
      ...
      <div className={"px-5 py-3 w-full"}>
        <div className={"flex flex-col items-start gap-2 w-full"}>
          <p
            className={
              "text-[#6C6C6C] text-left text-sm !leading-[14px] font-fancy"
            }
          >
            {name}
          </p>
          ...
          <div
            ...
            className={"text-white text-left text-lg !leading-5 font-fancy"}
          />
        </div>
      </div>
