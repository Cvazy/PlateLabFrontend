...
export const BoostYourSales = () => {
  return (
    <div
      className={
        "overflow-hidden rounded-[10px] border border-solid border-[#212121] bg-gradient-to-bl from-[#1b1b1b33] to-[#1B1B1B] w-full"
      }
    >
      <div className={"px-4 py-5 w-full h-full"}>
        <div className={"flex flex-col items-start gap-[30px] w-full h-full"}>
          <div className={"flex flex-col items-start gap-2.5 w-full"}>
            ...
            >
              Stunning visuals that drive customer engagement and increase order
              values
            </p>
          </div>
