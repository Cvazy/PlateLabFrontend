...
import { StarBorder } from "@/app/ReactBitsComponents";
...
export const ContactButton = () => {
  ...
  return (
    <DelayedLink
      href={"/contact"}
      data-cursor-text={"How to contact us"}
    ...
    >
      <StarBorder
        as="button"
        className={
          "flex items-center gap-2.5 rounded flex-nowrap px-4 bg-dark_gray h-9 hover:bg-[#2b2b2b]"
        }
        color="white"
        speed="5s"
        dataCursorText={"How to contact us"}
      >
        <p
          data-cursor-text={"How to contact us"}
          className={`uppercase text-white text-sm !leading-4 font-bold`}
        >
          Contact
        </p>
